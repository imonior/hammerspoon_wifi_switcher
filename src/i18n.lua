...
local locales = {
    zh = {
        ...
        log_init_success = "WiFi IP 切换器模块初始化成功。",
    ...
    en = {
        app_name = "WiFi Network Configuration Manager",
        unknown = "Unknown",
        ...
        log_init_success = "WiFi IP Switcher module initialized successfully.",
        log_force_apply_with_data = "Force apply with editor data: %s",
